    ...
    <main className="relative">
      <div className="container mx-auto px-6 py-10 md:py-16 lg:py-24 overflow-x-hidden overflow-y-hidden">
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10">
          ...
          >
            <h1 className="text-violet-400 text-5xl lg:text-7xl xl:text-7xl font-bold leading-tight uppercase heading">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-gray-900 via-blue-700 to-gray-400 opacity-90 pointer-events-none z-[-1]"></div>
    </main>
  );
}
